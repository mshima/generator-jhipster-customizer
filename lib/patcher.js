...
const verify = function (generator, object) {
  ...
  if (object.condition !== undefined && ((typeof object.condition === 'function' && !object.condition(generator._templateData())) || !object.condition)) {
    ...
    allParsed
      ...
      .forEach(fileTemplate => {
        ...
        if (typeof files === 'function') {
          files = files(generator._templateData());
        }
  ...
  processPartialTemplates(parsed) {
    ...
    parsed
      ...
      .forEach(templates => {
        ...
        let files = typeof templates.file === 'function' ? templates.file(generator._templateData()) : templates.file;
        ...
        templates.tmpls.forEach((item, index) => {
          ...
          const target = typeof item.target === 'function' ? item.target(generator._templateData()) : item.target;
          const tmpl = typeof item.tmpl === 'function' ? item.tmpl(generator._templateData()) : item.tmpl;
